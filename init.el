...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (xkcd use-package undo-tree try speed-type slime s rainbow-mode rainbow-delimiters pdf-tools paredit-everywhere ox-reveal org-bullets magit iedit htmlize hindent gnu-apl-mode flycheck expand-region diminish counsel company-ghci company-auctex chess ample-theme))))
(custom-set-faces
